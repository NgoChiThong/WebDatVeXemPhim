...
public interface BookRepository extends JpaRepository<Book, Integer> {
	...
	// lay danh sach ve
	@Query(value = "SELECT " + "o.order_id, " + "m.movie_name, "+"m.movie_poster, " + "s.schedule_date, " + "s.schedule_start, "
			+ "c.cinema_name, " + "r.room_name, "
			+ "GROUP_CONCAT(CONCAT(seat.seat_row, seat.seat_number) SEPARATOR ', ') AS seats " + "FROM orders o "
			...
			+ "GROUP BY o.order_id, m.movie_name, m.movie_poster, s.schedule_date, s.schedule_start, c.cinema_name, r.room_name ORDER BY  o.order_id DESC", nativeQuery = true)
