...
public interface BookRepository extends JpaRepository<Book, Integer> {
	...
	@Query(value = "SELECT " + "o.order_id, " + "m.movie_name, "+"m.movie_poster, " + "s.schedule_date, " + "s.schedule_start, "
			...
			+ "GROUP BY o.order_id, m.movie_name, m.movie_poster, s.schedule_date, s.schedule_start, c.cinema_name, r.room_name, o.total_price ORDER BY  o.order_id DESC", nativeQuery = true)
